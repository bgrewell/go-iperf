...
var file_control_proto_rawDesc = []byte{
	...
	,
}
...
var file_control_proto_depIdxs = []int32{
	0, // 0: api.Command.StartServer:input_type -> api.StartServerRequest
	1, // 1: api.Command.StartServer:output_type -> api.StartServerResponse
...
func (c *commandClient) StartServer(ctx context.Context, in *StartServerRequest, opts ...grpc.CallOption) (*StartServerResponse, error) {
	out := new(StartServerResponse)
	err := c.cc.Invoke(ctx, "/api.Command/StartServer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedCommandServer) StartServer(context.Context, *StartServerRequest) (*StartServerResponse, error) {
...
func _Command_StartServer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StartServerRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CommandServer).StartServer(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.Command/StartServer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommandServer).StartServer(ctx, req.(*StartServerRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Command_StartServer_Handler,
		},
	},
